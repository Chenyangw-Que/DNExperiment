...
class NAFNetLocal(Local_Base, MINAF):
    def __init__(self, *args, train_size=(1, 3, 256, 256), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        MINAF.__init__(self, *args, **kwargs)
...
if __name__ == '__main__':
    ...
    net = MINAF(img_channel=img_channel, width=width, middle_blk_num=middle_blk_num,
